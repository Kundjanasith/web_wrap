...
# df1 <- subset(df1, continent=="Ocean")
df1 <- subset(df1, continent=="South America")
...
# write.csv(res,file="oc4.csv",row.names=FALSE)
write.csv(res,file="sa4.csv",row.names=FALSE)
